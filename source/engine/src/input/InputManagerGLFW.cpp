...
namespace
{
    ...
    static const char* GetModsName(int mods)
    {
    ...
    static void MouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
    {
        ...
        Loops::Events::MouseButtonEvent mouseButtonEvent{};
        {
            ...
            mouseButtonEvent.keyname = GetButtonName(button);
            ...
            //currentMouseButtonState = mouseButtonEvent.keyState;
            //mouseButtonEvent.button = currentMouseButtonDown;
            //mouseButtonEvent.mouseX = (float)mouseX;
            //mouseButtonEvent.mouseY = (float)mouseY;
